                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        ...
                        <div class="col col-2">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" id="fecha-inicio" aria-describedby="inicio" placeholder="dd/mm/aaaa" style="font-size:small; border-color:#026993" v-model="editedItem.inicio" required pattern="[a-zA-Z0-9]+" title="Debe ingresar la fecha de la tarea">
                            </div>
                        </div>
                        <div class="col col-2">
                            <div class="input-group mb-2">
