    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form @submit.prevent="saveTask" class="needs-validation" novalidate>
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        <div class="col col-2">
                            <div class="input-group mb-2">
                                ...
                                <ul class="dropdown-menu">
                                    <li v-for="(itemAsignadoa, indexAsignado) of listaAsignado" :key="indexAsignado">
                        ...
                        <div class="col col-2">
                            <div class="input-group mb-2">
                                <div class="input-group-prepend">
                                    <span class="input-group-text group-label-text" id="estado"><label for="estado-tarea" class="form-label">Estado</label>
                                    </span>
                                </div>
                                <input type="text" class="form-control" id="estado-tarea" aria-describedby="estado" style="font-size: small; border-color: #026993" v-model="editedItem.estado" required />
                                <div class="invalid-tooltip">Falta el estado</div>
                            </div>
                        </div>
                        <div class="col col-2">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" id="fecha-inicio" aria-describedby="inicio" placeholder="dd/mm/aaaa" style="font-size: small; border-color: #026993" v-model="fecha" required pattern="[a-zA-Z0-9]+" title="Debe ingresar la fecha de la tarea" />
                            </div>
                        </div>
                        <div class="col col-2">
                            <div class="input-group mb-2">
                        ...
                        <div class="col">
                            <div class="input-group">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownPrioridad">
                                    <li v-for="(itemPrioridad, indexPrioridad) of listaPrioridad" :key="indexPrioridad">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" @click="saveTask()" data-bs-dismiss="modal">
                            Guadar
                        </button>
                    </div>
                </form>
