    ...
    <div class="container">
      <div class="row">
        <div class="col-4">
          <div class="input-group mb-4">
            ...
            <input type="text" class="form-control" id="basic-url" aria-describedby="search-user" placeholder="Buscar usuario" style="font-size:small">
          </div>
        </div>      
      </div>
      ...
      <div style="padding: 24px 24px 24px 24px;border: 1px solid #026993; background-color: #F0F0F0;">
        <div class="row justify-content-start">
          ...
          <div class="col-3">
            <div class="input-group">
              <div class="input-group-prepend">
                <span class="input-group-text group-label-text" id="search-estado">Rol
                </span>
              </div>
              <select class="form-select" size="3" id="dropdownEstado" aria-describedby="search-rol" multiple style="font-size:small; border-color:#026993">
      ...
      <div class="row justify-content-end" style="padding: 24px 0px 24px 24px;">
        <div class="col-2 align-self-end">
          <a href="/register">
          <button type="button" class="btn btn-primary btn-sm btn-action" id="btn-new-task">Nuevo Usuario</button>
          </a>
        </div>  
      </div>  
      <div class="row">
        <table class="table">
          <thead>
            <tr>
              ...
              <th class="label-header" scope="col">Nombre</th>
              <th class="label-header" scope="col">Apellido</th>
              <th class="label-header" scope="col">No. Identificación</th>
              <th class="label-header" scope="col">id Tipo </th>
              <th class="label-header" scope="col">Correo Electronico</th>
              <th class="label-header" scope="col">Rol</th>
          ...
          <tbody>
            <tr>
              <th scope="row">1</th>
              <td>William Efrain</td>
              <td>Abella Herrera</td>
              <td>C.C.</td>
              <td>79.307.332</td>
              <td>william.abella@gmail.com</td>
              <td>Adm</td>
              <td>Activo</td>
              <td>
                <button type="button" class="btn btn-update-data">
                ...
                <button type="button" class="btn btn-done-data">
